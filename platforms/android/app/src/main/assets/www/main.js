...
var AppComponent = /** @class */ (function () {
    function AppComponent(db, auth) {
        this.db = db;
        this.auth = auth;
        this.title = 'test-firebase';
        this.signIn();
    }
    AppComponent.prototype.signIn = function () {
        var _this = this;
        this.auth.auth.signInWithEmailAndPassword("vijay@gmail.com", "123456").then(function (user) {
            _this.title = user.user.email;
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyDCoDO6TkK9bJFD8RMouKMmQbxggDShMHU",
        authDomain: "test-firebase-7d7ad.firebaseapp.com",
        databaseURL: "https://test-firebase-7d7ad.firebaseio.com",
        projectId: "test-firebase-7d7ad",
        storageBucket: "test-firebase-7d7ad.appspot.com",
        messagingSenderId: "653398898744"
    }
};
/*
...
module.exports = __webpack_require__(/*! /Users/vgade/Desktop/cback/Technology/cordova/test-firebase/src/main.ts */"./src/main.ts");
